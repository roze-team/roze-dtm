...
schemas = {
    ...
    "DashboardTransactionRow": {"type": "object", "additionalProperties": False, "required": [
        "gid", "kind", "status", "branch_count", "completed_branch_count", "failed_branch_count",
        "total_attempts", "next_retry_millis", "created_at_millis", "updated_at_millis",
        "timeout_millis", "terminal", "xa_reconciliation_state", "available_actions",
    ], "properties": {
        "gid": {"type": "string"}, "kind": {"type": "string"}, "status": {"type": "string"},
        "branch_count": {"type": "integer", "minimum": 0},
        "completed_branch_count": {"type": "integer", "minimum": 0},
        "failed_branch_count": {"type": "integer", "minimum": 0},
        "total_attempts": {"type": "integer", "minimum": 0}, "next_retry_millis": nullable_u64,
        "created_at_millis": {"type": "integer", "minimum": 0},
        "updated_at_millis": {"type": "integer", "minimum": 0}, "timeout_millis": nullable_u64,
        "terminal": {"type": "boolean"}, "xa_reconciliation_state": nullable_string,
        "available_actions": {"type": "array", "items": {"type": "string", "enum": ["reset-retry", "force-stop"]}},
    }},
    "DashboardAuditEvent": {"type": "object", "additionalProperties": False, "required": [
        "sequence", "occurred_at_millis", "event", "outcome",
    ], "properties": {
        "sequence": {"type": "integer", "minimum": 0},
        "occurred_at_millis": {"type": "integer", "minimum": 0},
        "event": {"type": "string"}, "outcome": {"type": "string"},
        "resource_id": {"type": "string"}, "transaction_status": {"type": "string"},
    }},
    "DashboardSummary": {"type": "object", "additionalProperties": False, "required": [
        "total", "active", "succeeded", "aborted", "failed", "retry_scheduled",
        "xa_awaiting_decision", "xa_phase2_in_progress", "xa_manual_reconciliation_required",
        "by_kind", "by_status",
    ], "properties": {
        "total": {"type": "integer", "minimum": 0}, "active": {"type": "integer", "minimum": 0},
        "succeeded": {"type": "integer", "minimum": 0}, "aborted": {"type": "integer", "minimum": 0},
        "failed": {"type": "integer", "minimum": 0}, "retry_scheduled": {"type": "integer", "minimum": 0},
        "xa_awaiting_decision": {"type": "integer", "minimum": 0},
        "xa_phase2_in_progress": {"type": "integer", "minimum": 0},
        "xa_manual_reconciliation_required": {"type": "integer", "minimum": 0},
    ...
    "DashboardTransactionPage": {"type": "object", "additionalProperties": False,
        "required": ["items", "offset", "limit", "total"], "properties": {
            "items": {"type": "array", "items": ref("DashboardTransactionRow")},
            "offset": {"type": "integer", "minimum": 0},
            "limit": {"type": "integer", "minimum": 1, "maximum": 200},
            "total": {"type": "integer", "minimum": 0},
        }},
    "DashboardAuditTimeline": {"type": "object", "additionalProperties": False,
        "required": ["items", "limit", "capacity"], "properties": {
            "items": {"type": "array", "items": ref("DashboardAuditEvent")},
            "limit": {"type": "integer", "minimum": 1},
            "capacity": {"type": "integer", "minimum": 1},
        }},
    "DashboardSnapshot": {"type": "object", "additionalProperties": False,
        "description": "Bounded, redacted Roze Admin management snapshot",
        "required": ["generated_at_millis", "summary", "transactions", "audit"], "properties": {
            "generated_at_millis": {"type": "integer", "minimum": 0},
            "summary": ref("DashboardSummary"), "transactions": ref("DashboardTransactionPage"),
            "audit": ref("DashboardAuditTimeline"),
        }},
